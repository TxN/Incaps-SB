...
public class InputPlug : Gate 
{
    ...
    void BaseInit()
    {
        StrEditParameter o1Name = (StrEditParameter)RegisterParameter("Input 1 Name", EditableParameter.ParameterType.StrEdit);
        o1Name.SetValue("In1");

        StrEditParameter o2Name = (StrEditParameter)RegisterParameter("Input 2 Name", EditableParameter.ParameterType.StrEdit);
        o2Name.SetValue("In2");
    }
